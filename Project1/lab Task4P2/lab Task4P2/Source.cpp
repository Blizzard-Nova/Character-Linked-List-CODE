...
public:
    ...
    void min_max() {
        ...
        while (temp != NULL)
        {
            if (max_Size < temp->data.size())
            {
                max_Size = temp->data.size();
                cout << "Item with max size is " << " " << temp->data.size() << endl;
            }
           
            else if (max_Size > temp->data.size())
            {
                max_Size = temp->data.size();
                cout << "Item with min size is " << " " << temp->data.size() << endl;
            }
            temp = temp->next;
        }
